...
mypath='/Users/alex/AlexBadea_MyPapers/E3E4/E3E4_connectome_manuscript/tnpca_figs/'

outpath = '/Users/alex/code/Matlab/popNet_HOPCA/results_ab/Dipy/';
...
gen_type = 4;%1-gen0, 2-gen3, 3-gen4, 4-gen3&gen4, 5-ALl animal
age_type = 1;%1-all, 2-old, 3-young
...
f2 = figure(2);
scatter(data_x(:,1),data_x(:,2),[],data_y(:,3),'*','MarkerSize',20)
colormap(cmapsex);
...
f3 = figure(3);
scatter(data_x(:,2),data_x(:,3),[],data_y(:,3),'*','MarkerSize',20)
colormap(cmapsex);
